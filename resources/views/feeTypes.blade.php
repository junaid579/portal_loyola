        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject bold uppercase">Add Fee Types</span>
                </div>
            </div>
            <div class="portlet-body form">
                <form action="feeTypes" class="form-horizontal" method="POST" enctype="multipart/form-data">
                    <div class="form-body">
                       
                        <div class="form-group">
                            <label class="col-md-3 control-label">Fee Name</label>
                            <div class="col-md-4">
                                <input name="fee_name" id="fee_name" class="form-control" placeholder="Fee Name" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="caption font-dark" style="margin-top: 10px;">
                            ...
                            <span class="caption-subject bold uppercase"> Fee Types List</span>
                        </div>
                    </div>
                    <div class="col-md-6">
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-left" role="menu">
                                        ...
                                        <li>
                                            <a data-toggle="modal" href="#responsive" data-id="{{ $feeTypes->id }}" data-name="{{ $feeTypes->fee_name }}" data-heading="{{ $feeTypes->heading_on_bill }}" class="edit-data">
                                                <i class="icon-tag"></i> Edit </a>
                                        </li>
                                        <li class="divider"> </li>
                                        <?php if($feeTypes->status==1){ ?>
                                        <li>
                                            <a href="feeTypes/{{ $feeTypes->id }}/2">
                                                <i class="icon-flag"></i> Suspend  </a>
                                        </li>
                                        <li>
                                            <a href="feeTypes/{{ $feeTypes->id }}/0">
                                                <i class="icon-flag"></i> Delete  </a>
                                        </li>
                                        <?php }else if($feeTypes->status==2){ ?>
                                        <li>
                                            <a href="feeTypes/{{ $feeTypes->id }}/1">
                    ...
                    <div class="col-md-12">
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="icon-equalizer"></i>
                                    <span class="caption-subject bold uppercase">Edit Fee Types</span>
                                </div>
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="feeTypes" class="form-horizontal" method="POST" enctype="multipart/form-data" id="edit_form">
                                   <div class="form-body">
                       
                                       
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Fee Types</label>
                                            <div class="col-md-4">
                                                <input name="edit_fee_type" id = "edit_fee_type"  class="form-control" placeholder="Fee Type" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Heading on the Bill</label>
...
$(document).ready(function(){
    $("#sample_1").on("click",".edit-data", function(){
        ...
        $("#edit_fee_type").val( $(this).data("name") );
