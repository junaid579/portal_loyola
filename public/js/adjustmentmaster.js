$(document).ready(function() {
    $("#sample_1").on("click",".edit-data", function(){
        ...
        $("#edit_adjustment_reason").val( $(this).data("adjustment_reason") );
    });
    $("#sample_1").on("click",".view-data", function(){
        $("#view_adjustment_reason").html("");
        $("#view_adjustment_reason").html( $(this).data("adjustment_reason") );
    });
