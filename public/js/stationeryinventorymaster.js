...
$(document).ready(function() {
    $("#sample_1").on("click",".edit-data", function(){
        ...
        $("#edit_inventory_desc").val( $(this).data("inventory_desc") );

    });
    $("#sample_1").on("click",".view-data", function(){
        $("#view_inventory_desc").html("");
        $("#view_inventory_desc").html( $(this).data("inventory_desc") );
...
function getExportFileName(){
    ...
    return "StationeryInventoryMaster_"+df;
}
function getExportHeading(){
    return "StationeryInventoryMaster";
}