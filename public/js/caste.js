$(document).ready(function() {
    $("#sample_1").on("click",".edit-data", function(){
        ...
        $("#edit_caste_name").val( $(this).data("caste_name") );
        $("#edit_caste_code").val( $(this).data("caste_code") );
    });
    $("#sample_1").on("click",".view-data", function(){
        $("#view_caste_name, #view_caste_code").html("");
        $("#view_caste_name").html( $(this).data("caste_name") );
        $("#view_caste_code").html( $(this).data("caste_code") );
    });
